...
export default function RecipeSearch() {
  ...
  const handleSearch = async (event: FormEvent) => {
    ...
    try {
      ...
      console.log(data," data is trying to etch")
  ...
  return (
    <div className="flex flex-col h-full w-full max-w-6xl mx-auto p-4 md:p-6 ">
      {/* Header section */}
      <header className="flex flex-col mx-auto items-center max-w-[600px] mb-6">
        <h1 className="text-3xl font-bold mb-2 text-center">Recipe Search</h1>
        <p className="text-lg mb-4 text-center">
          Find delicious recipes by ingredients you have at home.
        </p>
        {/* Example search terms */}
        <div className="mb-4">
          <p className="text-center mb-2">Try searching for:</p>
